  			...
  			<?php }else if($Rich_Web_Slider_Effects[0]->slider_type=='Thumbnails Slider & Lightbox'){ ?>
				...
				<script type="text/javascript">
					...
					<?php 
						...
						trueFalse($Rich_Web_Slider_Effect[0]->Rich_Web_Sl_TSL_Loop);
						trueFalse($Rich_Web_Slider_Effect[0]->Rich_Web_Sl_TSL_PH);
						trueFalse($Rich_Web_Slider_Effect[0]->Rich_Web_Sl_TSL_AP);
						trueFalse($Rich_Web_Slider_Effect[0]->Rich_Web_Sl_TSL_TA);
						trueFalse($Rich_Web_Slider_Effect[0]->Rich_Web_Sl_TSL_Nav_Show);
						trueFalse($Rich_Web_Slider_Effect[0]->Rich_Web_Sl_TSL_SS_Show);
						trueFalse($Rich_Web_Slider_Effect[0]->Rich_Web_Sl_TSL_Arr_Show);
